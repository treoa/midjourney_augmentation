...
# def parse_args() -> None:
def parse_args(source_path: str=None, target_path: str=None, output_path: str=None) -> None:
    ...
    roop.globals.output_path = normalize_output_path(roop.globals.source_path, roop.globals.target_path, roop.globals.output_path)
